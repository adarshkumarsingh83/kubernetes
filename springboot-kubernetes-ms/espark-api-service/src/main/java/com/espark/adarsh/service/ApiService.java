...
public class ApiService {
    ...
    public Map<String, String> getConfig() {
        log.info("label=api-service getConfig()");
        HashMap<String, String> addressResponse = new HashMap<String, String>();
        HashMap<String, String> employeeResponse = new HashMap<String, String>();
        HashMap<String, String> apiResponse = new HashMap<String, String>() {
            {
                put("api-name", applicationPropsConfig.getName());
                put("api-message", applicationPropsConfig.getMessage());
            }
        };
        addressResponse = this.addressService.getConfig();
        employeeResponse = this.employeeService.getConfig();
        apiResponse.putAll(addressResponse);
        apiResponse.putAll(employeeResponse);
        return apiResponse;
    }
